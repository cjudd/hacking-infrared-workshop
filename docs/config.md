...
During this lab, you will use Arduino IDE to write, upload and debug code on the ESP8266. Before you can do this however, you will have to configure it a little.
